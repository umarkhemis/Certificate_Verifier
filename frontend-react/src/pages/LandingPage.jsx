...
// import { useState } from "react";
// import { useNavigate } from "react-router-dom";
// import { Shield, Award, CheckCircle, ExternalLink, Users, Lock } from "lucide-react";
// import '../styles/LandingPage.css'
// import ConnectWallet from "./ConnectWallet";
...
// const schoolWallets = [
//   "0x39E8b7AC7b10558b7feA757398109f2116475D68",
// ];
...
//   const goToDashboard = () => {
//     if (schoolWallets.includes(wallet)) {
//       navigate("/issue");
//     } else if (wallet) {
//       navigate("/student");
//     }
...
//       icon: <Shield className="w-8 h-8" />,
//       title: "Secure & Immutable",
//       description: "Certificates stored on blockchain cannot be tampered with or falsified"
//     },
//     {
//       icon: <Award className="w-8 h-8" />,
//       title: "Instant Verification",
//       description: "Verify any certificate instantly without contacting institutions"
//     },
//     {
//       icon: <Users className="w-8 h-8" />,
//       title: "Multi-Institution",
...
//               <h1 className="text-5xl md:text-6xl font-bold text-white mb-6 leading-tight">
//                 Blockchain Certificate
//                 <span className="bg-gradient-to-r from-yellow-400 to-orange-500 bg-clip-text text-transparent"> System</span>
//               </h1>
//               <p className="text-xl text-gray-200 mb-8 max-w-2xl mx-auto leading-relaxed">
//                 Secure, verifiable, and tamper-proof digital certificates powered by blockchain technology. 
//                 Issue, manage, and verify educational credentials with complete transparency.
//               </p>
//             </div>
...
//             {/* Call to Action */}
//             <div className="mt-12">
//               <p className="text-gray-300 mb-4">Don't have a certificate to verify?</p>
//               <button
//                 onClick={() => navigate("/verify")}
//                 className="inline-flex items-center space-x-2 text-white hover:text-gray-200 underline underline-offset-4 transition-colors"
//               >
...
//                 <div className="flex items-center space-x-2 mb-4">
//                   <Lock className="w-6 h-6 text-white" />
//                   <span className="text-xl font-bold text-white">TrustCert</span>
//                 </div>
//                 <p className="text-gray-400 text-sm leading-relaxed">
//                   Revolutionizing digital credentials with blockchain technology. 
//                   Secure, verifiable, and globally accessible certificate management.
//                 </p>
//               </div>
...
// const schoolWallets = [
//   // "0x1234567890ABCDEF...", // Replace with real school wallet addresses
//   // "0xe31b18ab503ee6b65c2650436e819fb7634b94ed",
//   "0xe4B79d06f8aDF45783e1d83D8C11170f54458B64",
// ];
...
//       <h1 className="text-4xl font-bold mb-4">Blockchain Certificate System</h1>
//       <ConnectWallet onConnected={handleWalletConnect} />
//       {wallet && (
//         <>
//           <p className="mt-4 text-sm text-gray-700">
//             Your wallet: <span className="font-mono">{wallet}</span>
//           </p>
//           <button
//             onClick={goToDashboard}
